...
function widget_shortcode( $atts, $content = null ) {
	...
	// search for the widget area where the widget resides
	...
	$args = apply_filters( 'widget_shortcode_args', array(
		'before_widget'	=> ( $atts['before_widget'] ) ? $atts['before_widget'] : $wp_registered_sidebars[$widget_area]['before_widget'],
		'before_title'	=> ( $atts['before_title'] ) ? $atts['before_title'] : $wp_registered_sidebars[$widget_area]['before_title'],
		'after_title'	=> ( $atts['after_title'] ) ? $atts['after_title'] : $wp_registered_sidebars[$widget_area]['after_title'],
		'after_widget'	=> ( $atts['after_widget'] ) ? $atts['after_widget'] : $wp_registered_sidebars[$widget_area]['after_widget']
	) );
